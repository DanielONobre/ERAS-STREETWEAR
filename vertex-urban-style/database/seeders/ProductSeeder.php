    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'brand_slug'    => 'eras',
                'name'          => 'Camiseta Oversized Eras Logo',
                'slug'          => 'camiseta-oversized-eras-logo',
                'sku'           => 'VTX-TSH-001',
                'price'         => 149.90,
                'compare_price' => 189.90,
                'cost_price'    => 45.00,
                'stock'         => 80,
                'description'   => '<p>Camiseta oversized com bordado tonal do logo Eras. Confeccionada em algodão premium 100% ringspun com gramatura 220g/m². Fit relaxed com ombros caídos e barra reta.</p>',
                'short_desc'    => 'Oversized com bordado tonal. Algodão 220g premium.',
                'is_featured'   => true,
                'images'        => [
                    ['url' => 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800', 'alt' => 'Camiseta Oversized Eras Logo — Frente'],
                    ['url' => 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=800', 'alt' => 'Camiseta Oversized Eras Logo — Costas'],
                ],
                'colors'        => ['Preto', 'Branco', 'Cinza'],
                'meta_title'    => 'Camiseta Oversized Eras Logo | Streetwear',
                'meta_desc'     => 'Camiseta oversized com bordado tonal Eras. Algodão premium 220g.',
            ],
            [
                'category_slug' => 'streetwear',
            ...
            [
                'category_slug' => 'streetwear',
                'brand_slug'    => 'eras',
                'name'          => 'Shorts Cargo Eras 5 Pocket',
                'slug'          => 'shorts-cargo-eras-5-pocket',
                'sku'           => 'VTX-SRT-001',
                'price'         => 199.90,
                'compare_price' => null,
                'cost_price'    => 65.00,
                ...
                'is_featured'   => false,
                'images'        => [
                    ['url' => 'https://images.unsplash.com/photo-1591195853828-11db59a44f43?w=800', 'alt' => 'Shorts Cargo Eras'],
                ],
                'colors'        => ['Preto', 'Verde Militar', 'Cinza'],
                'meta_title'    => 'Shorts Cargo 5 Pocket Eras',
            ...
            [
                ...
                'brand_slug'    => 'eras',
                'name'          => 'Parka Oversized Eras Arctic',
                'slug'          => 'parka-oversized-eras-arctic',
                'sku'           => 'VTX-PRK-001',
                'price'         => 899.90,
                ...
                'is_featured'   => true,
                'images'        => [
                    ['url' => 'https://images.unsplash.com/photo-1539533018447-63fcce2678e3?w=800', 'alt' => 'Parka Oversized Eras Arctic'],
                    ['url' => 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800', 'alt' => 'Parka Eras Arctic — Detalhe'],
                ],
                'colors'        => ['Preto', 'Verde Militar'],
                'meta_title'    => 'Parka Oversized Arctic Eras',
            ...
            [
                ...
                'brand_slug'    => 'eras',
                'name'          => 'Boné Snapback Eras 6-Panel',
                'slug'          => 'bone-snapback-eras-6-panel',
                'sku'           => 'VTX-CAP-001',
                'price'         => 129.90,
                'compare_price' => null,
                'cost_price'    => 40.00,
                'stock'         => 70,
                'description'   => '<p>Boné snapback 6 painéis com estrutura em twill de algodão. Aba plana com bordado tonal do logo Eras. Ajuste snapback em plástico acetal. Faixa de suor em terry interno.</p>',
                'short_desc'    => 'Snapback 6 painéis. Bordado tonal. Aba plana.',
                'is_featured'   => false,
                'images'        => [
                    ['url' => 'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=800', 'alt' => 'Boné Snapback Eras'],
                ],
                'colors'        => ['Preto', 'Branco', 'Cinza'],
                'meta_title'    => 'Boné Snapback 6-Panel Eras',
            ...
            [
                'category_slug' => 'sale',
                'brand_slug'    => 'eras',
                'name'          => 'Bucket Hat Eras Washed',
                'slug'          => 'bucket-hat-eras-washed',
                'sku'           => 'VTX-BKT-001',
                'price'         => 99.90,
                ...
                'is_featured'   => false,
                'images'        => [
                    ['url' => 'https://images.unsplash.com/photo-1521369909029-2afed882baee?w=800', 'alt' => 'Bucket Hat Eras Washed'],
                ],
                'colors'        => ['Preto', 'Cinza', 'Verde Militar'],
                'meta_title'    => 'Bucket Hat Washed Eras — Sale',
                'meta_desc'     => 'Bucket hat stonewashed Eras em promoção.',
            ],
        ];
